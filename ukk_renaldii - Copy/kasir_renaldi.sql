...
(2202053804, 'renaldi', 'bangkalannnn', '0987346736'),
(2202053849, 'rahmat', 'blegaaaa', '354356');
...
(1, '0000-00-00', 2500.00, 2202053804),
(2, '0000-00-00', 120000.00, 2202053849);
...
(1, 'celana', 500.00, 10),
(2, 'iphone 12 pro max', 9000.00, 20),
(4, 'gelang', 280000.00, 30),
(9, 'hp', 16000.00, 3);
...
--
ALTER TABLE `pelanggan`
  MODIFY `PelangganID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2202053850;
